...
(let* ((class '((class color) (min-colors 89)))
       ...
       (berrys11       "#B99558") ; math

       (berrys12        "#827979") ; fg-dim (Alternative: #A3A19F)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,berrys05 :weight normal))))
   ...
   `(font-lock-type-face ((,class (:foreground ,berrys02))))
   ...
   `(org-drawer ((,class (:inherist unspecified :foreground ,berrys-comment))))
   `(org-ellipsis ((,class (:inherit unspecified :foreground ,berrys07))))
   ...
   `(org-special-keyword ((,class (:foreground ,berrys05))))
   `(org-table ((,class (:foreground ,berrys02))))
   `(org-tag ((,class(:inherit org-level-1 :foreground ,berrys03 :weight normal))))
